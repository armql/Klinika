...
export default function CTA() {
    ...
    return (
        <section className="xl:px-48 lg:px-24 md:px-12 sm:px-6 px-2 py-24">
            <div
                className="bg-gradient-to-b overflow-hidden relative from-primary/60 to-primary/50 rounded-2xl w-full flex flex-col gap-4 items-center justify-center text-center text-white">
                <div
                    className="border-t-[400px] border-t-transparent border-r-[500px] border-r-compact/70 -z-10 absolute bottom-0 right-0"/>
                <div
                    className="border-b-[400px] border-b-transparent border-l-[500px] border-l-compact/40 -z-10 absolute top-0 left-0"/>
